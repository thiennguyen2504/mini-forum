...
def setup_logging(service_name: str = "notification-service", log_level: int = logging.INFO) -> None:
    """
    Cấu hình logging định dạng JSON structured cho notification-service.
    """
